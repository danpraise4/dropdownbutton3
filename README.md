...
<a href="https://pub.dev/packages/dropdown_button3">
  <img src="https://img.shields.io/pub/v/dropdown_button3?label=Pub"/>
</a>
...
- [Usage and Examples](#usage-and-examples)
  - [1. Simple DropdownButton2 with no styling](#1-simple-dropdownbutton3-with-no-styling)
  - [2. DropdownButton2 with some styling and customization](#2-dropdownbutton3-with-some-styling-and-customization)
  - [3. DropdownButton2 with items of different heights like dividers](#3-dropdownbutton3-with-items-of-different-heights-like-dividers)
  - [4. DropdownButton2 as Multiselect Dropdown with Checkboxes](#4-dropdownbutton3-as-multiselect-dropdown-with-checkboxes)
  - [5. DropdownButton2 as Searchable Dropdown](#5-dropdownbutton2-as-searchable-dropdown)
  - [6. DropdownButton2 as Popup menu button using customButton parameter](#6-dropdownbutton3-as-popup-menu-button-using-custombutton-parameter)
  - [7. Using DropdownButtonFormField2 with Form](#7-using-dropdownbuttonformfield2-with-form)
- [CustomDropdownButton2 Widget "customize it to your needs"](#customdropdownbutton3-widget-customize-it-to-your-needs)
